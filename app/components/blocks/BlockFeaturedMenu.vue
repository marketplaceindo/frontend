...
type Data = Extract<Block, { type: "featured_menu" }>["data"];
    ...
    <ul class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      >
        ...
        <div class="p-4">
          ...
          <p v-if="item.description" class="mt-1 text-sm opacity-75">{{ item.description }}</p>
          <p v-if="item.price !== undefined" class="mt-2 font-semibold text-primary">
